    ...
    setup = { attr }: {
      home = { # (Home-Manager Module)
        ...
        config.home.packages = with attr.packageChannel; [
          ...
          trash-cli # Trash-Cli: Interface for Freedesktop.org Trash
        ...
        config.programs.mpv = {
          ...
          # Install
          scripts = with attr.packageChannel; [ mpvScripts.uosc ];
          ...
          scriptOpts = {
            ...
            "uosc" = {
              ...
              "timeline_step" = "-${(attr.mpv-config).seekStepSmall}"; # Step in seconds, when scrolling
              ...
              "controls" = (utils.joinStr "," [
                ...
                (utils.joinStr "" [ # Speed-down button
                  "command" # Type
                  ":fast_rewind" # Icon
                  ":${(attr.mpv-actions).speedDownNoOSC}" # Command
                  "?Decrease speed" # Tooltip
                ])
                (utils.joinStr "" [ # Reset speed button
                  "command" # Type
                  ":speed" # Icon
                  ":${(attr.mpv-actions).resetSpeedNoOSC}" # Command
                  "?Reset speed" # Tooltip
                ])
                (utils.joinStr "" [ # Speed-up button
                  "command" # Type
                  ":fast_forward" # Icon
                  ":${(attr.mpv-actions).speedUpNoOSC}" # Command
              ...
              "volume_step" = (attr.mpv-config).volumeStep; # Step in %, when scrolling
              ...
              "flash_duration" = (attr.mpv-config).osc-duration; # Duration in ms of the flash
